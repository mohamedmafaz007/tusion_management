...
import { c as useHydrated, t as Badge, u as useSettings } from "./hooks-CxGWPwWy.mjs";
import { D as Menu, E as MessageSquare, K as Clock, M as LayoutDashboard, P as GraduationCap, T as Moon, a as UserPlus, at as ChartColumn, ct as CalendarCheck, d as Sun, et as ChevronRight, h as Search, k as LogOut, lt as BookOpen, n as Wallet, p as Settings, q as Circle, r as Users, rt as Check, t as X, ut as Bell } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/AppShell-DLgJ9Z3L.js
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
				...
				children: nav.map((item) => {
					const active = item.exact ? pathname === item.to : item.to === "/students" ? pathname === "/students" || pathname.startsWith("/students/") && !pathname.startsWith("/students/new") : pathname === item.to || pathname.startsWith(item.to + "/");
...
function AppShell({ children }) {
	...
	const formattedTime = time ? time.toLocaleDateString("en-IN", {
		weekday: "short",
		day: "numeric",
		month: "short",
		year: "numeric"
	...
	(0, import_react.useEffect)(() => {
		if (!hydrated) return;
		if (!localStorage.getItem("tms.auth_token")) {
			if (pathname !== "/login") window.location.href = "/login";
		} else if (pathname === "/login") window.location.href = "/";
	}, [hydrated, pathname]);
	const toggleTheme = () => {
		setSettingsState({
			...settings,
	...
	if (pathname === "/login") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("main", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("header", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							formattedTime && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "hidden md:flex items-center gap-2 font-mono text-xs font-semibold text-muted-foreground bg-secondary/40 px-3 py-1.5 rounded-xl border border-border/60 ml-4",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Clock, { className: "h-3.5 w-3.5 text-primary animate-pulse" }), formattedTime]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
