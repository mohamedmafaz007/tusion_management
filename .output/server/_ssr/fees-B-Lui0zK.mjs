...
import { D as sendWhatsAppReceipt, n as Input, t as Button } from "./db-BwnUP-Gi.mjs";
import { a as uid, c as useHydrated, d as useStudents, i as STANDARDS, s as useFees, u as useSettings } from "./hooks-6SRUr3Oq.mjs";
import { I as History, N as LoaderCircle, X as Clock, b as Receipt, h as Search, m as Send, n as Wallet, tt as CircleCheckBig, x as Printer } from "../_libs/lucide-react.mjs";
...
import { t as StatCard } from "./StatCard-CFNHjO8F.mjs";
import { n as FeeStatusBadge } from "./StatusBadges-D7UWYwbU.mjs";
import { a as studentAvatarStyle, n as formatCurrency, r as initials, t as currentMonthKey } from "./derive-C375yk92.mjs";
import { a as TableHeader, i as TableHead, n as TableBody, o as TableRow, r as TableCell, t as Table } from "./table-m3yKmvf2.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/fees-B-Lui0zK.js
...
function FeesPage() {
	...
	const rows = (0, import_react.useMemo)(() => {
		return students.filter((s) => (standard === "all" || s.standard === standard) && (!q || s.name.toLowerCase().includes(q.toLowerCase()))).filter((s) => (s.joiningDate || "").slice(0, 7) <= month || fees.some((f) => f.studentId === s.id && f.month === month)).map((s) => {
			return {
				student: s,
	...
	if (!hydrated) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: "Loading fees workspace..."
	});
