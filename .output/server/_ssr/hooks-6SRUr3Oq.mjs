...
import { A as syncDbMaterials, M as syncDbStudents, O as syncDbAttendance, b as isDbConfigured, f as getDbAttendance, g as getDbStudents, h as getDbSettings, j as syncDbSettings, k as syncDbFees, m as getDbMaterials, p as getDbFees, s as cn } from "./db-BwnUP-Gi.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/hooks-6SRUr3Oq.js
...
var getTeachers = () => read(KEYS.teachers, []);
var setTeachers = (v) => write(KEYS.teachers, v);
...
function useTeachers() {
	const [state, setState] = (0, import_react.useState)(getTeachers);
	(0, import_react.useEffect)(() => {
		const handler = (e) => {
			const detail = e.detail;
...
//#endregion
export { uid as a, useHydrated as c, useStudents as d, useTeachers as f, STANDARDS as i, useMaterials as l, DEFAULT_SETTINGS as n, useAttendance as o, MATERIAL_TYPES as r, useFees as s, Badge as t, useSettings as u };
