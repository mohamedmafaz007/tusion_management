...
import { C as useHydrated, d as getDbMaterials, i as Input, m as isDbConfigured, n as Button, s as cn, w as useMaterials } from "./hooks-D6hNI9RI.mjs";
...
import { n as PageHeader } from "./AppShell-CJAo8Cx0.mjs";
import { a as SelectValue, i as SelectTrigger, n as SelectContent, r as SelectItem, t as Select } from "./select-BaOTDBYe.mjs";
import { n as STANDARDS, t as MATERIAL_TYPES } from "./types-BX1Dn8M6.mjs";
import { t as Label } from "./label-BOyqj1XQ.mjs";
import { a as DialogHeader, i as DialogFooter, n as DialogContent, o as DialogTitle, t as Dialog } from "./dialog-5xw31t0d.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/materials-DNwXAFPA.js
...
function MaterialsPage() {
	...
	const [isLoadingList, setIsLoadingList] = (0, import_react.useState)(false);
	(0, import_react.useEffect)(() => {
		const fetchMaterials = async () => {
			...
			try {
				...
				if (data && Array.isArray(data)) setMaterialsState(data);
			} catch (err) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			isLoadingList ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: [
					...
					className: "glass animate-pulse flex flex-col gap-3 rounded-2xl p-4",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-start justify-between",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-11 w-11 rounded-xl bg-muted/30" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-4 w-16 rounded bg-muted/30" })]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "space-y-2 mt-2",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-4 w-3/4 rounded bg-muted/30" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-3 w-1/2 rounded bg-muted/30" })]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "mt-auto flex gap-1 pt-4",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-8 flex-1 rounded-lg bg-muted/30" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-8 flex-1 rounded-lg bg-muted/30" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-8 w-8 rounded-lg bg-muted/30" })
							]
						})
					]
				}, i))
