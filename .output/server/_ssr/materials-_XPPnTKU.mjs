...
import { n as Input, s as cn, t as Button } from "./db-yVcJeqUS.mjs";
import { c as useHydrated, i as STANDARDS, l as useMaterials, r as MATERIAL_TYPES, u as useSettings } from "./hooks-CxGWPwWy.mjs";
...
import { n as PageHeader } from "./AppShell-DLgJ9Z3L.mjs";
...
import { a as DialogHeader, i as DialogFooter, n as DialogContent, o as DialogTitle, t as Dialog } from "./dialog-CS2JoaR2.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/materials-_XPPnTKU.js
...
function MaterialsPage() {
	...
	const standardsList = (0, import_react.useMemo)(() => settings?.standards || STANDARDS, [settings]);
	const [standard, setStandard] = (0, import_react.useState)("6th");
	(0, import_react.useEffect)(() => {
		if (standardsList.length > 0 && !standardsList.includes(standard)) setStandard(standardsList[0]);
	}, [standardsList, standard]);
	const [type, setType] = (0, import_react.useState)("all");
	const [mediumFilter, setMediumFilter] = (0, import_react.useState)("all");
	...
	const filtered = (0, import_react.useMemo)(() => materials.filter((m) => m.standard === standard).filter((m) => type === "all" || m.type === type).filter((m) => mediumFilter === "all" || (m.medium || "English") === mediumFilter).filter((m) => !q || m.title.toLowerCase().includes(q.toLowerCase()) || m.fileName.toLowerCase().includes(q.toLowerCase())), [
		materials,
		standard,
		type,
		mediumFilter,
	...
	const countByStd = (s) => materials.filter((m) => m.standard === s && (mediumFilter === "all" || (m.medium || "English") === mediumFilter)).length;
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [m.driveFileId ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: [m.driveFileId ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									...
									className: cn("rounded-full px-2 py-0.5 text-[10px] font-bold uppercase", (m.medium || "English") === "Tamil" ? "bg-amber-100 dark:bg-amber-950/50 text-amber-600 dark:text-amber-400" : "bg-blue-100 dark:bg-blue-950/50 text-blue-600 dark:text-blue-400"),
									children: m.medium || "English"
								})]
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, { children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "space-y-1.5",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, { children: "Medium of Study" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
									value: form.medium,
									onValueChange: (v) => setForm({
										...form,
										medium: v
