...
import { s as cn, t as Button } from "./db-BwnUP-Gi.mjs";
import { c as useHydrated, d as useStudents, i as STANDARDS, o as useAttendance, s as useFees } from "./hooks-6SRUr3Oq.mjs";
import { a as UserPlus, ft as CalendarCheck, gt as ArrowRight, i as UserX, l as TrendingUp, lt as ChartColumn, n as Wallet, o as UserCheck, pt as BookOpen, q as Download, r as Users } from "../_libs/lucide-react.mjs";
...
import { a as studentAvatarStyle, n as formatCurrency, r as initials, s as todayKey, t as currentMonthKey } from "./derive-C375yk92.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-nPPo62pu.js
...
function DashboardPage() {
	...
	const stats = (0, import_react.useMemo)(() => {
		...
		const unpaidStudents = students.filter((s) => (s.joiningDate || "").slice(0, 7) <= cm && !fees.some((f) => f.studentId === s.id && f.month === cm));
		const pending = monthFees.reduce((s, f) => s + (f.amount - f.paidAmount), 0) + unpaidStudents.reduce((s, st) => s + st.monthlyFees, 0);
