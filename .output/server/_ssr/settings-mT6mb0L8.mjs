...
import { A as syncDbMaterials, M as syncDbStudents, O as syncDbAttendance, c as connectBaileys, d as getBaileysStatus, k as syncDbFees, n as Input, s as cn, t as Button, u as disconnectBaileys } from "./db-BwnUP-Gi.mjs";
import { c as useHydrated, n as DEFAULT_SETTINGS, u as useSettings } from "./hooks-6SRUr3Oq.mjs";
import { E as Moon, F as KeyRound, N as LoaderCircle, _ as Save, d as Sun, mt as Bell, s as Upload, tt as CircleCheckBig } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/settings-mT6mb0L8.js
...
function SettingsPage() {
	...
	const [isPasswordUpdating, setIsPasswordUpdating] = (0, import_react.useState)(false);
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "grid h-10 w-10 place-items-center rounded-lg gradient-brand text-white shadow-glow",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(KeyRound, { className: "h-5 w-5" })
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
							className: "font-semibold text-lg",
							children: "Change Login Password"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "text-xs text-muted-foreground",
							children: "Update the administrator password used to login to this dashboard."
						})] })]
