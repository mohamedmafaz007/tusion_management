...
import { c as useHydrated, d as useStudents, i as STANDARDS, o as useAttendance, s as useFees, t as Badge } from "./hooks-6SRUr3Oq.mjs";
import { K as Eye, T as Pencil, a as UserPlus, at as ChevronLeft, h as Search, ht as ArrowUpDown, it as ChevronRight, q as Download, u as Trash2, z as Funnel } from "../_libs/lucide-react.mjs";
...
import { a as studentAvatarStyle, i as studentAttendancePct, n as formatCurrency, o as studentFeeStatus, r as initials } from "./derive-C375yk92.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/students.index-C308ayCv.js
...
function StudentsPage() {
	...
	const filtered = (0, import_react.useMemo)(() => {
		let out = students.filter((s) => {
			const matchQ = !q || s.name.toLowerCase().includes(q.toLowerCase()) || (s.registrationNo || "").toLowerCase().includes(q.toLowerCase()) || s.parentName.toLowerCase().includes(q.toLowerCase()) || s.fatherMobile.includes(q);
	...
	const exportCsv = () => {
		const csv = [[
			...
			s.school,
			s.standard,
			s.boardOfStudy || "State Board",
			s.mediumOfStudy || "English",
			s.parentName,
			s.fatherMobile,
	...
	if (!hydrated) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: "Loading students workspace..."
	});
